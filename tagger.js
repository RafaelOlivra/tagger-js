...
if (window.tagger) {
    ...
    window.tagger = {
        ...
        _init: async function () {
            ...
            window.taggerUserURLParams = this.getUserURLParams();
         ...
         */
        fireCallback: function (event, data) {
            if (typeof this.mainCallback === "function") {
                this.mainCallback(event, data);
            } else {
        ...
        /**
         * Returns the user URL parameters from the tagger storage or URL.
         * @returns {object} - The user parameters.
         */
        getUserURLParams: function () {
        ...
        /**
         * Returns a specific user URL parameter from the tagger storage or URL.
         * @param {string} param - The parameter to retrieve.
         * @returns {string} - The user parameter.
         */
        getUserURLParam: function (param) {
            return this.getUserURLParams()[param];
        },
         ...
         * @returns {Promise<string>} - The new URL with the parameters moved and the user ID appended.
         */
        utilMoveURLParamsToNewURL: async function (url, appendUserID = true) {
